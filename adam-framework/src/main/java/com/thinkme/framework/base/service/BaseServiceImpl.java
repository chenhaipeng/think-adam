package com.thinkme.framework.base.service;

import com.thinkme.framework.page.OffsetPager;
import com.thinkme.framework.page.Pagination;
import com.thinkme.framework.page.datatable.DataTableColumn;
...
public class BaseServiceImpl<T> extends EntityService<T> implements BaseService<T> {
     ...
     */
    @Override
    public <T> T insertIgnoreNull(T obj) {
        return this.dao().insert(obj, true, false, true);
    }
