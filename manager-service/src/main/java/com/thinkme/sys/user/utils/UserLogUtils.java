package com.thinkme.sys.user.utils;

import com.thinkme.framework.utils.LogUtils;
...
public class UserLogUtils {
    ...
    public static Object getIp() {
        ...
        if (requestAttributes != null && requestAttributes instanceof ServletRequestAttributes) {
            return IPUtil.getIpAddr(((ServletRequestAttributes) requestAttributes).getRequest());
        }
