...
//						.setOutputDir("/develop/code/")//输出目录
						.setOutputDir("/Users/hai/IdeaProjects/mybatisplus-spring-boot/src/main/java/")//输出目录
...
//						.setUrl("jdbc:mysql://127.0.0.1:3306/mybatis-plus?characterEncoding=utf8")
				...
				new StrategyConfig()
				 ...
				 .setInclude(new String[] { "tm_system_code" }) // 需要生成的表
...
//						return "/develop/code/xml/" + tableInfo.getEntityName() + ".xml";
						return "/Users/hai/IdeaProjects/mybatisplus-spring-boot/src/main/resources/mapper/" + tableInfo.getEntityName() + ".xml";
					}
				}))
		).setTemplate(
